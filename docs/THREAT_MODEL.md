...
| Premature/wrong source release         | short-lived signed challenge bound to wallet/contest/tx/artifact; verify client and WinnerSettled on Arc | A valid challenge can be replayed during its five-minute lifetime; source is public to repository readers |
